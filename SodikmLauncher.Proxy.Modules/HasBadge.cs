...
internal class HasBadge : ProxyModule
{
	public override bool IsValidUrl(string absolutePath, string host)
	{
		return absolutePath.StartsWith("/game/badge/hasbadge.ashx");
	}
	...
	public override Task HandleRequest(SessionEventArgs e)
	{
		...
		string text = (GameService.Instance.HasBadge(Convert.ToInt64(nameValueCollection["badgeid"]), Convert.ToInt64(nameValueCollection["userid"])) ? "Success" : "Failure");
